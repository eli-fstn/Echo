...
function Navbar() {
  return (
    <div className="bg-white shadow-sm h-15 w-200 mx-auto flex justify-center items-center mt-5 rounded-4xl cursor-pointer">
      <div className="flex flex-row items-center justify-between w-full mx-10">
        <div className="flex flex-row items-center">
          ...
          <p className="font-mono text-[#232323] text-[1.7rem] mt-0.5">Echo</p>
        </div>
