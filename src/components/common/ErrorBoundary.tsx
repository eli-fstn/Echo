    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#FBF8F3] text-center px-4">
          <img src={ErrorImage} alt="Error Image" className="w-60" />
          <p className="font-mono text-[2rem] text-[#232323] mt-2">Something went wrong.</p>
          <p className="text-sm text-gray-500 mb-6">Try refreshing the page. If the issue continues, let us know.
          </p>
